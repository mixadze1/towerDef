...
public class ElectoRocketTower : Tower
{
    ...
    public override TowerType Type => TowerType.ElectroMortar;
    ...
    private void Launch(TargetPoint target)
    {
        ...
        _mortar.localRotation = Quaternion.LookRotation(dir) * Quaternion.Euler(15f, 0f, 0f);

        Game.SpawnShell().Initialize(launchPoint, targetPoint,
            new Vector3(s * cosTheta * dir.x, dir.y - 0.3f, s * cosTheta * dir.z), _shellBlastRadius, _damage, Type);
    }
}